...
export const DEMO_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1546868871-70c122467d8b?auto=format&fit=crop&q=80&w=800'],
    stock: 15,
  ...
  },
  {
    ...
    discountPrice: 1600,
    category: 'Women',
    images: ['https://images.unsplash.com/photo-1572804013307-a9a111d72f8b?auto=format&fit=crop&q=80&w=800'],
    stock: 40,
    sizes: ['S', 'M', 'L'],
    rating: 4.4,
    reviewsCount: 18,
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1544816153-199d88bb1166?auto=format&fit=crop&q=80&w=800'],
    stock: 60,
